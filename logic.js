...
var earthquakeUrl = "http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2014-01-01&endtime=" +
...
function createFeatures(earthquakeData, plateData) {
  ...
  plateData.forEach((plateElement) => {
    element = [];
    plateElement.geometry.coordinates.forEach((plateCoords) => {
        element.push([plateCoords[1], plateCoords[0]])
    })
    plateMarkers.push(
      L.polyline(element, {
        color: "orange"
